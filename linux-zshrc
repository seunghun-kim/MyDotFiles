...
export PATH=$HOME/bin:/usr/local/bin:/home/seunghun/stlink/build/Release/:$PATH
...
POWERLEVEL9K_BATTERY_LEVEL_FOREGROUND=(white white white white black black black black white white white)
...
POWERLEVEL9K_SSH_ICON="\uF0AC"  # Globe
#POWERLEVEL9K_SSH_ICON="\uF1EB"  # WiFi
